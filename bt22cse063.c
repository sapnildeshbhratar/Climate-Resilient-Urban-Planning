...
void set_input(Station_param X[])
{
    ...
    Station_param first = {1, 0.7f, 83, 450, 13, 2, 0, {0, 126, 58, 68, 58}, {22, 15, 19, 21, 25, 15, 19, 21, 24, 22, 23, 20, 23, 20, 17, 22, 25, 15, 21, 23, 18, 24, 15, 22, 22, 15, 18, 18, 23, 24}, {85, 89, 84, 76, 76, 85, 82, 78, 94, 78, 78, 81, 94, 95, 86, 93, 88, 80, 88, 89, 86, 95, 90, 86, 82, 82, 84, 83, 81, 83}};
    Station_param second = {2, 0.9f, 91, 350, 12, 3, 0, {126, 0, 113, 68, 98}, {17, 18, 14, 16, 19, 14, 15, 16, 15, 17, 18, 13, 19, 12, 15, 14, 17, 19, 17, 12, 12, 15, 14, 18, 15, 16, 13, 20, 14, 17}, {87, 80, 83, 82, 91, 91, 95, 82, 82, 81, 83, 84, 87, 95, 81, 80, 95, 83, 86, 90, 83, 83, 92, 88, 88, 96, 88, 96, 92, 97}};
    Station_param third = {3, 0.4f, 53, 550, 8, 7, 1, {58, 113, 0, 68, 58}, {25, 32, 32, 33, 32, 34, 35, 26, 28, 33, 34, 29, 30, 32, 30, 28, 26, 25, 36, 38, 39, 35, 34, 38, 39, 37, 36, 32, 36, 31}, {68, 68, 58, 56, 56, 57, 63, 68, 69, 59, 54, 61, 53, 60, 57, 64, 63, 65, 57, 61, 55, 62, 57, 68, 64, 66, 53, 54, 61, 61}};
    Station_param fourth = {4, 0.5f, 46, 590, 5, 10, 1, {68, 68, 68, 0, 58}, {30, 28, 33, 27, 25, 29, 34, 32, 31, 26, 25, 33, 30, 27, 35, 29, 26, 34, 28, 32, 33, 30, 26, 31, 27, 25, 34, 33, 29, 35}, {74, 73, 62, 67, 69, 60, 63, 61, 73, 80, 72, 78, 66, 61, 64, 72, 79, 67, 71, 71, 73, 65, 61, 80, 68, 77, 64, 77, 62, 67}};
    Station_param fifth = {5, 0.6f, 39, 450, 3, 12, 1, {58, 98, 58, 58, 0}, {31, 28, 28, 38, 33, 36, 36, 32, 32, 27, 31, 27, 33, 30, 30, 37, 31, 35, 37, 35, 28, 29, 29, 31, 35, 32, 37, 31, 37, 36}, {82, 67, 82, 59, 59, 83, 80, 60, 60, 78, 79, 81, 83, 57, 71, 69, 79, 80, 77, 68, 72, 76, 75, 80, 75, 58, 60, 65, 57, 64}};
...
int main()
{
    ...
    generate_testLog(new_file, "<Execution stated Successfully> :", __FILE__, __LINE__, __TIME__);
    ...
    else
    {
        ...
        for (int i = 0; i < n; ++i)
        {
            ...
            scanf("%d", &X[i].previous_surface_fraction);
